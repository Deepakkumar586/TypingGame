...
/* class add in html element */
function addClass(el, name) {
  el.className += " " + name;
}

/* class remove in html element */
function removeClass(el, name) {
  el.className += el.className.replace(name, "");
}

/* All Words Print On UI*/
function newGame() {
  ...
  for (let i = 0; i < 200; i++) {
   ...
   /* add class function call here---->Html element: word and  ---- name which class will be added 'current */
...
/* ak seperate word me formet all words */
